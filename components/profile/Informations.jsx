...
function Informations() {
  ...
  return (
    ...
    isEditClicked ? <ChangeInfos isEditClicked={isEditClicked} setIsEditClicked={setIsEditClicked} /> : 
    ...
    <div className="w-screen h-screen bg-radial-gradient flex flex-col items-center">
      ...
      <Button variant="gradientPurple" size="lg" className="mx-auto mt-20 block text-white" onClick={() => {console.log(setIsEditClicked(true))}}>Edit informations</Button>
    </div>
