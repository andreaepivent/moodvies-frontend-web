  ...
  return (
    <div className="h-screen bg-radial-gradient flex flex-col items-center justify-around">
      ...
      <div className="w-full h-36 flex flex-col">
        ...
        <p className="text-white mt-0 ml-40">
          <span className="text-fuchsia-500">156h</span> de Moodage
        </p>
      </div>
      ...
      <div className="w-[80%] h-[5%] flex justify-between border-b">
        <h2 className="text-white text-xl mb-3 flex flex-col justify-end">
          Collection
        </h2>
        <h3 className="text-white text-xl font-thin mb-3 flex flex-col justify-end">
          last watched
        </h3>
      </div>
      <CollectionCarousel />
